...
os.system("clear")
os.system("cls & title HARA Spam Sms 2025 & mode 70,18")
colorsPool = itertools.cycle([27, 33, 69, 74, 74, 73, 73, 73, 78, 114, 114, 113, 113, 155, 155, 155, 155, 155, 155, 191, 191, 185, 185, 185, 185, 185, 185, 221, 221, 221, 221, 221, 215, 215, 215, 209, 209, 209, 203, 203, 203, 204, 204, 204, 198, 198, 129, 129, 135, 99, 99, 99, 99, 63, 63, 63, 63, 69, 69, 69,68])
...
def HYPRE():
	...
	ui = """
 BY 
 _    _    __    ___  ____  _  _    ____  _   _ 
( \/\/ )  /__\  / __)(_  _)( \( )  (_  _)( )_( )
 )    (  /(__)\ \__ \ _)(_  )  (     )(   ) _ ( 
(__/\__)(__)(__)(___/(____)(_)\_)   (__) (_) (_)
👽
